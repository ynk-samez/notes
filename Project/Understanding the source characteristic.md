...
## Optimizers
>[! Outline]
>In neural networks, *optimizers* are algorithms that determine _how the model’s parameters (weights and biases) are updated during training_ so that the loss function is minimized.  
